...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 75.69
  #define DEFAULT_bedKi 14.53
  #define DEFAULT_bedKd 262.93
#endif // PIDTEMPBED
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 2000, 2000, 10, 50 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT (Y_MAX_POS-37)  // Y point for Z homing
#endif
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_TYPE   (NEO_GRBW | NEO_KHZ800 | NEO_SK6812) // NEO_GRBW / NEO_GRB - four/three channel driver type (defined in Adafruit_NeoPixel.h)
